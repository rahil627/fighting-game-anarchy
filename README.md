...
if that's not enough, you can halp me make [the site](https://rahil627.github.io/fighting-game-anarchy/)(!!), to which the wiki may be ported to soon. The site's source here (in the docs folder); it's hosted and automatically built by GitHub Pages, generated using Jekyll. Just ask for permission (git access permissions). Sooo much to do!! :) :) Find an awesome theme. Set up databases (flat-file, simple). Add cool art 'n animation!
- - -
